...
#
#     Image/JPEG; /Users/treddell/.mutt/view_attachment %s
#     Image/PNG; /Users/treddell/.mutt/view_attachment %s
#     Image/GIF; /Users/treddell/.mutt/view_attachment %s
#
#     Application/PDF; /Users/treddell/.mutt/view_attachment %s
#
#         #This HTML example passes the type because file doesn't always work and
#         #there aren't always extensions.
#
#     text/html; /Users/treddell/.mutt/view_attachment %s html
#
...
#
#     Application/vnd.ms-excel; /Users/treddell/.mutt/view_attachment %s "-" '/Applications/OpenOffice.org1.1.2/Start_OpenOffice.org.app'
#     Application/msword; /Users/treddell/.mutt/view_attachment %s "-" '/Applications/OpenOffice.org1.1.2/Start_OpenOffice.org.app'
#
#
